...
/*jshint ignore:start*/
(function() {
  function oa(m, q) { m.prototype = ab(q.prototype);
      m.prototype.constructor = m;
      m.base = q.prototype }

  function ab(m) {
      function q() {}
      q.prototype = m; return new q }
  ...
  function ha(m, q) { var s = !1;
      0 > m && (s = !0, m *= -1);
      m = "" + m; for (q = q ? q : 1; m.length < q;) m = "0" + m; return s ? "-" + m : m }

  function Ga(m) { if (!m) return m;
      m = m.replace(/^\s\s*/, ""); for (var q = /\s/, s = m.length; q.test(m.charAt(--s));); return m.slice(0, s + 1) }
  ...
  function S(m) { var q = ((m & 16711680) >> 16).toString(16),
          s = ((m & 65280) >> 8).toString(16);
      m = ((m & 255) >> 0).toString(16);
      q = 2 > q.length ? "0" + q : q;
      s = 2 > s.length ? "0" + s : s;
      m = 2 > m.length ? "0" + m : m; return "#" + q + s + m }
      ...
      if (isNaN(y)) {
          try {
              m = "position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:" + m + "; font-size:" +
                  q + "px; font-weight:" + s + ";";
              if (!qa) { var x = document.body;
                  qa = document.createElement("span");
                  qa.innerHTML = ""; var z = document.createTextNode("Mpgyi");
                  qa.appendChild(z);
                  x.appendChild(qa) }
              qa.style.display = "";
  ...
  function O(m, q, s, v) { return m.addEventListener ? (m.addEventListener(q, s, v || !1), s) : m.attachEvent ? (v = function(q) { q = q || window.event;
          q.preventDefault = q.preventDefault || function() { q.returnValue = !1 };
          q.stopPropagation = q.stopPropagation || function() { q.cancelBubble = !0 };
          s.call(m, q) }, m.attachEvent("on" + q, v), v) : !1 }
  ...
  function Xa(m, q, s) {
      ...
      q = !0;
      for (s = 0; 4 > s; s++)
          if (m[s] !== m[s + 4] | m[s] !== m[s + 8] | m[s] !== m[s + 12]) { q = !1; break }
      return q ? m[0] << 16 | m[1] << 8 | m[2] : 0
  }

  function ma(m, q, s) { return m in q ? q[m] : s[m] }

  function Ha(m, q, s) { if (v && Ya) { var y = m.getContext("2d");
          ...
          m.width = q * ga;
          m.height = s * ga;
          Ra !== Ma && (m.style.width = q + "px", m.style.height = s + "px", y.scale(ga, ga)) } else m.width = q, m.height = s }
  ...
  function pa(m, q, s) { for (var v in s) q.style[v] = s[v] }
  ...
  function Na() { for (var m = null, q = 0; q < arguments.length; q++) m = arguments[q], m.style && (m.style.display = "inline") }

  function wa() { for (var m = null, q = 0; q < arguments.length; q++)(m = arguments[q]) && m.style && (m.style.display = "none") }
  ...
  function Ea(m, q, s, v, y) { "undefined" === typeof y && (y = 0);
      this._padding = y;
      this._x1 = m;
      this._y1 = q;
      this._x2 = s;
  ...
  function ka(m, q) { ka.base.constructor.call(this, "TextBlock", null, q, null, null);
      this.ctx = m;
      this._isDirty = !0;
  ...
  var ba = 20,
      ...
      Ta = {
          ...
          subtitles: [{ fontFamily: Fa, fontSize: z, fontColor: fa, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
  ...
  Fa = {
      ...
      data: [{ indexLabelFontFamily: x, indexLabelFontSize: z, indexLabelFontColor: U, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
      axisX: [{
          titleFontFamily: x,
          titleFontSize: ba,
          titleFontColor: U,
  ...
  (function() {
      $.fSDec = function(m) { for (var q = "", s = 0; s < m.length; s++) q += String.fromCharCode(Math.ceil(m.length / 57 / 5) ^ m.charCodeAt(s)); return q };
      ...
      $._fTWm = function(m) { if ("undefined" === typeof $.pro.sCH && !Za) try { var q = m[$.fSDec($.obj.cntx)];
              q[$.fSDec($.obj.txtBl)] = $.fSDec($.obj.tp);
              q[$.fSDec($.obj.fnt)] = 11 + $.fSDec($.obj.fntStr);
              q[$.fSDec($.obj.fSy)] = $.fSDec($.obj.grClr);
              q[$.fSDec($.obj.fTx)]($.fSDec($.obj.trVs), 2, m.height - 11 - 2) } catch (s) {} }
  })();
  var Wa = {},
      qa = null,
      Ba = function() {
      ...
      X = function(m, q, s) {
          ...
          for (var W = 0; R && W < R.length; W++)
              if (q = R[W], "." === q && 0 > C) C = W;
                  ...
                  if ("%" === q) z *= 100;
                  else if ("\u2030" === q) { z *= 1E3; continue } else if ("," === q[0] && "." === q[q.length - 1]) { z /= Math.pow(1E3, q.length - 1);
                      C = W + q.length - 1; continue } else "E" !== q[0] && "e" !== q[0] || "0" !== q[q.length - 1] || (O = !0);
                  0 > C ? (Q.push(q), "#" === q ||
          ...
          else "E" !== q[0] && "e" !== q[0] || "0" !== q[q.length - 1] || !/[eE][+-]*[0]+/.test(q) ? "," === q ? (W++, R = O, O = 0, 0 < z.length && (s = x + s)) : s = 1 < q.length && ('"' === q[0] && '"' === q[q.length - 1] || "'" === q[0] && "'" === q[q.length - 1]) ? q.slice(1, q.length - 1) + s : q + s : (q = 0 > $ ? q.replace("+", "").replace("-", "") : q.replace("-", ""), s += q.replace(/[0]+/, function(m) { return ha($, m.length) }));
          x = "";
      ...
      Ma = 1,
      ga = Ya ? Ra / Ma : 1,
      ja = function(m) { for (var q = "", s = 0; s < m.length; s++) q += String.fromCharCode(Math.ceil(m.length / 57 / 5) ^ m.charCodeAt(s)); return q },
  ...
  Y.prototype.setOptions = function(m, q) { if (ra[this._defaultsKey]) { var s = ra[this._defaultsKey],
              v; for (v in s) "publicProperties" !== v && s.hasOwnProperty(v) && (this[v] = m && v in m ? m[v] : q && v in q ? q[v] : s[v]) } };
  Y.prototype.get = function(m) { var q = ra[this._defaultsKey]; if ("options" === m) return this.options && this.options._isPlaceholder ? null : this.options; if (q.hasOwnProperty(m) || q.publicProperties && q.publicProperties.hasOwnProperty(m)) return this[m];
  ...
  Y.prototype.trackChanges = function(m) { if (!this.sessionVariables) throw "Session Variable Store not set";
  ...
  Y.prototype.removeEventListener = function(m, q) { if (m && q && this._eventListeners[m])
          for (var v = this._eventListeners[m], y = 0; y < v.length; y++)
              if (v[y].eventHandler === q) { v[y].splice(y, 1); break } };
  Y.prototype.removeAllEventListeners =
      function() { this._eventListeners = [] };
  Y.prototype.dispatchEvent = function(m, q, v) { if (m && this._eventListeners[m]) { q = q || {}; for (var y = this._eventListeners[m], x = 0; x < y.length; x++) y[x].eventHandler.call(y[x].context, q) } "function" === typeof this[m] && this[m].call(v || this.chart, q) };
  ...
  ka.prototype.setText = function(m) { this.text = m;
      this._isDirty = !0;
      this._wrappedText = null };
  ka.prototype.measureText = function() { this._lineHeight = Va(this.fontFamily, this.fontSize, this.fontWeight); if (null === this.maxWidth) throw "Please set maxWidth and height for TextBlock";
  ...
  ka.prototype._getLineWithWidth = function(m, q, v) {
      ...
      for (this.ctx.font = this._getFontString(); y <= x;) { var z = Math.floor((y + x) / 2),
              G = m.substr(0, z + 1);
          v = this.ctx.measureText(G).width; if (v < q) y = z + 1;
          else if (v > q) x = z - 1;
          else break }
  ...
  ka.prototype._getFontString = function() { var m;
      m = "" + (this.fontStyle ? this.fontStyle + " " : "");
      m += this.fontWeight ? this.fontWeight + " " : "";
      m += this.fontSize ? this.fontSize + "px " : ""; var q = this.fontFamily ? this.fontFamily + "" : "";!v && q && (q = q.split(",")[0], "'" !== q[0] && '"' !== q[0] && (q = "'" + q + "'")); return m += q };
  oa(Sa, Y);
  oa(Ia, Y);
  ...
  oa(Ja, Y);
  var La = { addTheme: function(m, v) { ya[m] = v }, addColorSet: function(m, v) { Aa[m] = v }, addCultureInfo: function(m, v) { Ka[m] = v }, formatNumber: function(m, v, s) { s = s || "en"; if (Ka[s]) return X(m, v || "#,##0.##", new Ja(s)); throw "Unknown Culture Name"; }, formatDate: function(m, v, s) { s = s || "en"; if (Ka[s]) return Ba(m, v || "DD MMM YYYY", new Ja(s)); throw "Unknown Culture Name"; } };
  ...
  La.Chart = function() {
              ...
              this.canvas.getContext &&
                  (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ca(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Ca(this._preRenderCtx), v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ua(c, e), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
                      ...
                      this._toolBar.setAttribute("class", "canvasjs-chart-toolbar"), this._toolBar.style.cssText = "position: absolute; right: 1px; top: 1px;", this._canvasJSContainer.appendChild(this._toolBar), this.bounds = { x1: 0, y1: 0, x2: this.width, y2: this.height }, O(this.overlaidCanvas, "click", function(a) { b._mouseEventHandler(a) }), O(this.overlaidCanvas, "mousemove", function(a) { b._mouseEventHandler(a) }), O(this.overlaidCanvas, "mouseup", function(a) { b._mouseEventHandler(a) }), O(this.overlaidCanvas, "mousedown", function(a) {
                          ...
                          function(a) { b._touchEventHandler(a) }), this.toolTip = new Z(this, this.options.toolTip), this.data = null, this.axisX = [], this.axisX2 = [], this.axisY = [], this.axisY2 = [], this.sessionVariables = { axisX: [], axisX2: [], axisY: [], axisY2: [] })
      ...
      s.prototype._updateOptions = function() {
          ...
          if (this.options.zoomEnabled) {
              if (!this._zoomButton) {
                  ...
                  O(this._zoomButton, "click", function() { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, va(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, va(a, a._zoomButton, "pan"));
                      a.render() });
          ...
          if (!this._dropdownMenu && this.exportEnabled && v) {
              ...
              O(this._dropdownMenu, "blur", function() { wa(a._dropdownMenu);
              ...
              O(b, "mouseover", function() { f || (this.style.backgroundColor = a.toolbar.backgroundColorOnHover, this.style.color = a.toolbar.fontColorOnHover) }, !0);
              O(b, "mouseout", function() { f || (this.style.backgroundColor = a.toolbar.backgroundColor, this.style.color = a.toolbar.fontColor) }, !0);
              O(b, "click", function() { q(a.canvas, "jpeg", a.exportFileName);
                  wa(a._dropdownMenu) }, !0);
              b = document.createElement("div");
              b.style.cssText =
              ...
              O(b,
                  "click",
                  function() { q(a.canvas, "png", a.exportFileName);
                      wa(a._dropdownMenu) }, !0)
          }
      ...
      s.prototype._updateSize = function() {
          ...
          return this.canvas.width !== a * ga || this.canvas.height !== f * ga ? (Ha(this.canvas, a, f), Ha(this._preRenderCanvas, a, f), Ha(this.overlaidCanvas, a, f), Ha(this._eventManager.ghostCanvas, a, f), this.bounds = { x1: 0, y1: 0, x2: this.width, y2: this.height }, !0) : !1
      };
      ...
      s.prototype.assignIdToDataPoints = function() { for (var a = 0; a < this.data.length; a++) { var f = this.data[a]; if (f.dataPoints)
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
              for (var f =
                  ...
                  for (n = 0; n < p.dataPoints.length; n++) {
                      ...
                      c < b.min && (b.min = c);
                      c > b.max && (b.max = c);
                      if (0 < n) { if (a.axisX.logarithmic) { var m = c / p.dataPoints[n - 1].x;
                              1 > m && (m = 1 / m);
                      ...
                      if (!(c < D) || p) {
                          ...
                          if (b.viewPortMin === c && e)
                              for (v = 0; v < e.length; v++)
                                  if (null === e[v] && d < c) { b.viewPortMin = d; break }
      ...
      s.prototype.clearCanvas = function() { this.ctx.clearRect(0, 0, this.width, this.height);
      ...
      s.prototype._touchEventHandler = function(a) {
          if (a.changedTouches && this.interactivityEnabled) {
              ...
              if (!(b && 1 < b.length)) {
                  e = Pa(c);
                  e.time = new Date;
                  try { var h = e.y - this._lastTouchData.y,
                          g = e.time - this._lastTouchData.time; if (15 < Math.abs(h) && (this._lastTouchData.scroll || 300 > g)) { this._lastTouchData.scroll = !0; var l = window.parent || window;
                          l && l.scrollBy && l.scrollBy(0, -h) } } catch (t) {}
      ...
      s.prototype._plotAreaMouseDown = function(a, f) { this.isDrag = !0;
      ...
      s.prototype._zoomPanToSelectedRegion = function(a, f, b, c, e) { a = this.validateRegion(a, f, b, c, e);
      ...
      s.prototype.renderIndexLabels = function(a) {
          ...
          for (a = 0; a < this._indexLabels.length; a++) {
              ...
              if (k.dataSeries.indexLabelFormatter || k.dataPoint.indexLabelFormatter) T = { chart: this, dataSeries: k.dataSeries, dataPoint: k.dataPoint, index: k.indexKeyword, total: u.total, percent: u.percent };
                          ...
                          for (var q = !1, u = 0; u < r.length; u++)
                              if (T = r[u].x.getTime ? r[u].x.getTime() : r[u].x, !(T < a.axisX.dataInfo.viewPortMin || T > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !q)))
                                  if ("number" !== typeof r[u].y) 0 <
                                      ...
                                      if (0 < r[u].markerSize || 0 < k.markerSize) { var A = k.getMarkerProperties(u, T, H, b);
                                          g.push(A);
                                          s = S(s);
                                          v && g.push({ x: T, y: H, ctx: c, type: A.type, size: A.size, color: s, borderColor: s, borderThickness: A.borderThickness }) }(r[u].indexLabel || k.indexLabel || r[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: r[u], dataSeries: k, point: { x: T, y: H }, direction: 0 > r[u].y === a.axisY.reversed ? 1 : -1, color: w })
                                  }
                          b.stroke();
                          v && c.stroke()
                      }
                      ...
                      for (var q = !1, u = 0; u < r.length; u++)
                          if (T = r[u].getTime ? r[u].x.getTime() : r[u].x, !(T < a.axisX.dataInfo.viewPortMin || T > a.axisX.dataInfo.viewPortMax &&
                              ...
                              if ("number" !== typeof r[u].y) 0 < u && !(k.connectNullData || q || D) && (b.stroke(), v && c.stroke()), q = !0;
                                  ...
                                  if (0 < r[u].markerSize || 0 < k.markerSize) s = k.getMarkerProperties(u, T, H, b), g.push(s), A = S(A), v && g.push({ x: T, y: H, ctx: c, type: s.type, size: s.size, color: A, borderColor: A, borderThickness: s.borderThickness });
                      ...
                      for (T = !1, D = 0; D < r.length; D++)
                          if (u = r[D].getTime ? r[D].x.getTime() : r[D].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !T)))
                              if ("number" !== typeof r[D].y) 0 < D && !T && (k.connectNullData ? c.setLineDash && (0 < H.length && (k.options.nullDataLineDashType || !r[D - 1].lineDashType)) && (H[H.length -
                                  ...
                                  if (0 < r[D].markerSize || 0 < k.markerSize) { var q = k.getMarkerProperties(D, u, T, c);
                                      h.push(q);
                                      s = S(s);
                                      v && h.push({ x: u, y: T, ctx: e, type: q.type, size: q.size, color: s, borderColor: s, borderThickness: q.borderThickness }) }(r[D].indexLabel || k.indexLabel || r[D].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: r[D], dataSeries: k, point: { x: u, y: T }, direction: 0 > r[D].y === a.axisY.reversed ? 1 : -1, color: w });
                                  T = !1
                              }
                  f(H)
              }
                      ...
                      for (k = 0; k < u.length; k++)
                          if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                              ...
                              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) l[c] = u[k].y + (l[c] ? l[c] : 0), 0 < l[c] && (p = a.axisY.convertValueToPixel(l[c]),
                                  ...
                                  p -= A;
                                  y = n - A;
                                  g[c] = A + (y - p) } else A = h[c] ? h[c] : 0, y = p + A, p = n + A, h[c] = A + (y - p);
                      ...
                      for (var s = 5 < d && D.bevelEnabled ?
                          ...
                          if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                              ...
                              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                  ...
                                  g[c] = A + (B - p) } else A = "undefined" !== typeof h[c] ? h[c] : 0, B = p + A, p = n + A, a.dataSeriesIndexes.length - 1 === w && 1 >= Math.abs(e.y2 - B) && (B = e.y2), h[c] =
                                  A + (B - p);
                              c = u[k].color ? u[k].color : D._colorSet[k % D._colorSet.length];
                      ...
                      for (k = 0; k < u.length; k++)
                          if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                              ...
                              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                  ...
                                  g[c] = A + (r - s) } else A = h[c] ? h[c] : 0, s = r - A, r = n - A, a.dataSeriesIndexes.length - 1 === w && 1 >= Math.abs(e.x1 - s) && (s = e.x1),
                                  h[c] = A + (r - s);
                              c = u[k].color ? u[k].color : D._colorSet[k % D._colorSet.length];
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                  ...
                  if (0 < m.length) {
                      ...
                      b = "solid";
                      if (g.setLineDash) { var J = G(w.nullDataLineDashType, w.lineThickness);
                          b = w.lineDashType; var ca = G(b, w.lineThickness);
                          g.setLineDash(ca) }
                      ...
                      for (m = !1; d < n.length; d++)
                          if (w = n[d].x.getTime ? n[d].x.getTime() : n[d].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !m)))
                              if ("number" !== typeof n[d].y) 0 < d && !m && (p.connectNullData ? c.setLineDash && (0 < q.length && (p.options.nullDataLineDashType || !n[d - 1].lineDashType)) && (q[q.length - 1].newLineDashArray = M, z = p.nullDataLineDashType) : (f(), q = [])), m = !0;
                                  ...
                                  this._eventManager.objectMap[J] = { id: J, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: d, x1: w, y1: m };
                                  q[q.length] = { x: w, y: m };
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                  ...
                  if (0 < m.length) {
                      ...
                      g.lineWidth = w.lineThickness;
                      var J = "solid";
                      if (g.setLineDash) { var ca = G(w.nullDataLineDashType, w.lineThickness),
                              J = w.lineDashType,
      ...
      s.prototype.renderStackedArea =
          function(a) {
              function f() { if (!(1 > t.length)) { for (0 < A.lineThickness && c.stroke(); 0 < t.length;) { var a = t.pop();
                          c.lineTo(a.x, a.y);
                          v && s.lineTo(a.x, a.y) }
                      c.closePath();
              ...
              if (!(0 >= a.dataSeriesIndexes.length)) {
                  ...
                  for (x = 0; x < a.dataSeriesIndexes.length; x++) {
                      ...
                      if (0 < k.length) {
                          ...
                          y = "solid";
                          if (c.setLineDash) { var J = G(A.nullDataLineDashType, A.lineThickness);
                          ...
                          for (var da = !0, p = 0; p < k.length; p++) {
                              ...
                              if (!(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !da)))
                                  if ("number" !== typeof aa.y) A.connectNullData || (da || q) || f(), da = !0;
                                      ...
                                      var xa = l[w] ? l[w] : 0;
                                      if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { r[w] = aa.y + (r[w] ? r[w] : 0); if (0 >= r[w] && a.axisY.logarithmic) continue;
                                          d = a.axisY.convertValueToPixel(r[w]) } else d = a.axisY.convertValueToPixel(aa.y), d -= xa;
                                      t.push({ x: n, y: m - xa });
                                      l[w] = m - d;
                                      q ||
                                      ...
                                      if (0 <= A.dataPointIndexes[w]) { var na = A.dataPointIds[A.dataPointIndexes[w]];
      ...
      s.prototype.renderStackedArea100 = function(a) {
          function f() { for (0 < A.lineThickness && c.stroke(); 0 < t.length;) { var a = t.pop();
                  c.lineTo(a.x, a.y);
                  v && y.lineTo(a.x, a.y) }
              c.closePath();
              c.globalAlpha = A.fillOpacity;
                          ...
                          for (var M = x._colorSet,
                              ...
                              if (!(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax) && !y(B[l].y) && B[l].y.length && "number" === typeof B[l].y[0] && "number" === typeof B[l].y[1]) {
                                  ...
                                  if (B[l].indexLabel || x.indexLabel || B[l].indexLabelFormatter || x.indexLabelFormatter) this._indexLabels.push({ chartType: "error", dataPoint: B[l], dataSeries: x, indexKeyword: 0, point: { x: c ? B[l].y[1] >= B[l].y[0] ? r : p : r + (p - r) / 2, y: c ? n + (d - n) / 2 : B[l].y[1] >= B[l].y[0] ? d : n }, direction: B[l].y[1] >= B[l].y[0] ? -1 : 1, bounds: { x1: c ? Math.min(r, p) : r, y1: c ? n : Math.min(n, d), x2: c ? Math.max(r, p) : p, y2: c ? d : Math.max(n, d) }, color: e, axisSwapped: c }), this._indexLabels.push({
                                      ...
                                      dataSeries: x,
                                      indexKeyword: 1,
                                      point: { x: c ? B[l].y[1] >= B[l].y[0] ? p : r : r + (p - r) / 2, y: c ? n + (d - n) / 2 : B[l].y[1] >= B[l].y[0] ? n : d },
      ...
      s.prototype.renderRangeArea = function(a) {
          function f() {
              if (s) {
                  ...
                  c.globalAlpha = 1;
                  e.fill();
                  if (0 < r.lineThickness) { c.beginPath();
                      ...
                      for (d = !1; p < r.length; p++)
                          if (n = r[p].x.getTime ? r[p].x.getTime() : r[p].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                              ...
                              if (null !== r[p].y && r[p].y.length && "number" === typeof r[p].y[0] && "number" === typeof r[p].y[1]) {
                                  ...
                                  if (r[p].indexLabel || k.indexLabel || r[p].indexLabelFormatter || k.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: r[p], dataSeries: k, indexKeyword: 0, point: { x: n, y: d }, direction: r[p].y[0] <= r[p].y[1] ? -1 : 1, color: u }), this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: r[p], dataSeries: k, indexKeyword: 1, point: { x: n, y: w }, direction: r[p].y[0] <= r[p].y[1] ? 1 : -1, color: u });
                                  d = !1
                  ...
                  if (0 < q.length)
                      for (var y = 5 < n && m.bevelEnabled ? !0 : !1, x = !1, B = null, A = null, h = 0; h < q.length; h++)
                          if (q[h].getTime ? r = q[h].x.getTime() : r = q[h].x, "number" !==
                              typeof q[h].y) { if (0 < h && !x && m.connectNullData) var z = m.options.nullDataLineDashType || !q[h - 1].lineDashType ? m.nullDataLineDashType : q[h - 1].lineDashType;
                              x = !0 } else {
      ...
      var qa = function(a, f, b, c, e, g, h, l, t) {
          if (!(0 >
                  b)) { "undefined" === typeof l && (l = 1); if (!v) { var k = Number((h % (2 * Math.PI)).toFixed(8));
                  Number((g % (2 * Math.PI)).toFixed(8)) === k && (h -= 1E-4) }
              a.save();
              a.globalAlpha = l; "pie" === e ? (a.beginPath(), a.moveTo(f.x, f.y), a.arc(f.x, f.y, b, g, h, !1), a.fillStyle = c, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(f.x, f.y, b, g, h, !1), 0 <= t && a.arc(f.x, f.y, t * b, h, g, !0), a.closePath(), a.fillStyle = c, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
              a.globalAlpha = 1;
              a.restore() }
      };
          ...
          function(a) {
              ...
              function g(a, b, f) {
                  ...
                  if (0 <= a && a < r.length) {
                      ...
                      for (n = 1; n < r.length; n++)
                          if (h = (a - n + d.length) % d.length, d[h].hemisphere !== d[a].hemisphere) { h = null; break } else if (d[h].indexLabelText && d[h].hemisphere === d[a].hemisphere && h !== a && (0 > c(d[h], d[a]) || ("right" === d[a].hemisphere ? d[h].indexLabelTextBlock.y <= d[a].indexLabelTextBlock.y : d[h].indexLabelTextBlock.y >= d[a].indexLabelTextBlock.y))) break;
                      else h = null;
                      p = h;
                      t = e(a);
                      n = h = 0;
                  ...
                  for (var b = a = 0, f = 0, h = !0, b = 0; 10 > b && (1 > b || 0 < f); b++) {
                      ...
                      if ("inside" !== k.indexLabelPlacement) {
                          ...
                          for (var u, y, a = 0; a < r.length; a++) {
                              ...
                              if (null !== B) { u = d[a];
                                  y = d[B]; var z = 0,
                                      z = c(u, y) - m; if (0 > z) { for (var G = y = 0, ta = 0; ta < r.length; ta++) ta !== a && d[ta].hemisphere === l.hemisphere && (d[ta].indexLabelTextBlock.y < l.indexLabelTextBlock.y ? y++ : G++);
                                      y = z / (y + G || 1) * G; var G = -1 * (z - y),
                                          I = ta = 0; "right" === l.hemisphere ? (ta = g(a, y), G = -1 * (z - ta), I = g(B, G), +I.toFixed(v) < +G.toFixed(v) && +ta.toFixed(v) <= +y.toFixed(v) && g(a, -(G - I))) : (ta = g(B, y), G = -1 * (z - ta), I = g(a, G), +I.toFixed(v) < +G.toFixed(v) && +ta.toFixed(v) <= +y.toFixed(v) && g(B, -(G - I))) } }
                          }
                      } else
              ...
              if (!(0 >= a.dataSeriesIndexes.length)) {
                  ...
                  if (0 !== z) {
                      ...
                      this.pieDoughnutClickHandler = function(a) { t.isAnimating || !y(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && t._animator.animate(0, 500, function(a) { b(a);
                              l() })) };
                      f();
                      h();
                      h();
                      ...
                      this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                          ...
                          for (b = 0; b < r.length; b++) { var c = 0 === b ? d[b].startAngle : e,
                                  e = c + (d[b].endAngle - d[b].startAngle),
                                  f = !1;
                              e > a && (e = a, f = !0); var g = r[b].color ? r[b].color : k._colorSet[b % k._colorSet.length];
                              e > c && qa(t.plotArea.ctx, d[b].center, d[b].radius, g, k.type, c, e, k.fillOpacity, d[b].percentInnerRadius); if (f) break }
                          l()
                      }, function() {
                          t.disableToolTip = !1;
      ...
      var ra = function(a, f, b, c) { "undefined" === typeof b && (b = 1);
      ...
      s.prototype.renderFunnel =
          function(a) {
              function f() { for (var a = 0, b = [], c = 0; c < x.length; c++) { if ("undefined" === typeof x[c].y) return -1;
                      x[c].y = "number" === typeof x[c].y ? x[c].y : 0;
                      a += Math.abs(x[c].y) } if (0 === a) return -1; for (c = b[0] = 0; c < x.length; c++) b.push(Math.abs(x[c].y) * P / a); return b }
              ...
              function e() {
                  ...
                  e = !1;
                  c = 0;
                  for (var g = Q - W - V / 2, g = u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth > g ? g : u.indexLabelMaxWidth : g, h = F.length - 1; 0 <= h; h--) { dataPoint = x[F[h].id];
                      c = F[h];
                      d = c.textBlock;
                      b = (a = n(h) < N.length ? F[n(h)] : null) ? a.textBlock : null;
                      c = c.height;
                      a && d.y + c + ga > b.y && (e = !0);
                      c = dataPoint.indexLabelMaxWidth || g; if (c > g || 0 > c) c = g;
                      f.push(c) }
                  if (e)
              ...
              function h() {
                  ...
                  function b() {
                      ...
                      for (k = N.length - 1; 0 < k; k--)
                          if (!F[k].isDirty) { e = p(k); if (0 > e && (e = 0, F[e].isDirty)) break; if (F[k].textBlock.y < F[e].textBlock.y + F[e].height) { d = d || k;
                                  f = k; for (h = 0; F[f].textBlock.y < F[e].textBlock.y + F[e].height + ga;) { a = a || F[f].textBlock.y + F[f].height;
                                      h += F[f].height;
                                      h += ga;
                                      f = e; if (0 >= f) { f = 0;
                                          h += F[f].height; break }
              ...
              function t(a, b, c) {
                  var d, e, f, h = [],
                      l = C,
                      n = []; - 1 !== b && (0 <= la.indexOf(b) ? (e = la.indexOf(b), la.splice(e, 1)) : (la.push(b), la = la.sort(function(a, b) { return a - b })));
                  if (0 === la.length) h = ja;
                  else {
                      e = C * (1 != la.length || 0 != la[0] && la[0] != N.length - 1 ? 2 : 1) / k();
                      for (var t = 0; t < N.length; t++) {
                          if (1 ==
                              la.length && 0 == la[0]) { if (0 === t) { h.push(ja[t]);
                  ...
                  var p = {
                      ...
                      duration: c || 500,
                      easingFunction: function(a, b, c, d) { return I.easing.easeOutQuart(a, b, c, d) },
              ...
              function k() { for (var a = 0, b = 0; b < N.length - 1; b++)(0 <= la.indexOf(b) || 0 <= la.indexOf(b + 1)) && a++; return a }
              ...
              function p(a) { for (a -= 1; - 1 <= a && -1 != a && F[a].isDirty; a--); return a }

              function n(a) { for (a += 1; a <= N.length && a != N.length && F[a].isDirty; a++); return a }

              function d(a) { for (var b, c = 0; c < x.length; c++)
                      if (N[c].y1 < a && N[c].y4 > a) { b = N[c]; break }
              ...
              if (!(0 >= a.dataSeriesIndexes.length)) {
                  ...
                  if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                      ...
                      if (-1 !== J) {
                          ...
                          if (K && u.visible && (c(), g(), e(), "inside" !== u.indexLabelPlacement)) { h(); for (E = 0; E < x.length; E++) F[E].isDirty || (a = F[E].textBlock.x + F[E].width, a = (Q - a) / 2, 0 == E && (A = a), A > a && (A = a)); for (E = 0; E < N.length; E++) N[E].x1 += A, N[E].x2 += A, N[E].x3 += A, N[E].x4 += A, N[E].x5 && (N[E].x5 += A, N[E].x6 += A), F[E].textBlock.x += A }
                          ...
                          if (!K)
                              for (E =
                                  0; E < x.length; E++) A = u.dataPointIds[E], a = { id: A, objectType: "dataPoint", dataPointIndex: E, dataSeriesIndex: 0, funnelSection: N[u.reversed ? x.length - 1 - E : E] }, s._eventManager.objectMap[A] = a;
                          ...
                          return { source: S, dest: this.plotArea.ctx, animationCallback: function(a, b) { I.fadeInAnimation(a, b);
                                  1 <= a && (t(s, -1, 500), q(s.plotArea.ctx || s.ctx)) }, easingFunction: I.easing.easeInQuad, animationBase: 0 }
                      }
                  }
              }
          };
      ...
      s.prototype.getPercentAndTotal = function(a, f) {
          ...
          else if ("pie" === a.type || "doughnut" === a.type || "funnel" === a.type || "pyramid" === a.type) { for (i = c = 0; i < a.dataPoints.length; i++) isNaN(a.dataPoints[i].y) || (c += a.dataPoints[i].y);
                  ...
                  if ("pie" !== n.type && "doughnut" !== n.type &&
                      ...
                      for (var x = 0; x < n.dataPoints.length; x++) {
                          var z = n.dataPoints[x],
                              ...
                              n.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: n, dataPoint: z }) : z.name ? z.name : "DataPoint: " + (x + 1),
                  ...
                  if (!(0 >= h || "undefined" === typeof h || 0 >= q || "undefined" === typeof q)) {
                      if ("horizontal" === this.orientation) {
                          ...
                          if (!n || n.width + Math.round(d.textBlock.width +
                                  s + l + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === d.chartType || "spline" === d.chartType || "stepLine" === d.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g) n = { items: [], width: 0 }, k.push(n), this.height += x, x = 0;
      ...
      R.prototype.getDataPointAtX = function(a, f) {
          ...
          for (;;) { g = 0 < h ? r + e : r - e; if (0 <= g && g < this.dataPoints.length) { var c = this.dataPoints[g],
                      p = this.axisX.logarithmic ? c.x > a ? c.x / a : a / c.x : Math.abs(c.x - a);
                  p < b.distance && (b.dataPoint = c, b.distance = p, b.index = g);
                  c = p;
                  c <= l ? l = c : 0 < h ? t++ : k++; if (1E3 < t && 1E3 < k) break } else if (0 > r - e && r + e >= this.dataPoints.length) break; - 1 === h ? (e++, h = 1) : h = -1 }
      ...
      C.prototype.createExtraLabelsForLog = function(a) {
          ...
          if (!(5 < a)) {
              ...
              if (Math.log(this.range) / Math.log(f / this.viewportMinimum) <
                  this.noTicks - 1) { for (var b = C.getNiceNumber((f - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), c = Math.ceil(this.viewportMinimum / b) * b; c < f; c += b) c < this.viewportMinimum || this.logLabelValues.push(c);
              ...
              if (this.logarithmic && !this.equidistantInterval)
                  for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), c = 0, d = n; c < this.logLabelValues.length; c++)
                      if (b =
                          ...
                          m = b;
                          a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: m, label: this.labels[m] ? this.labels[m] : null }) : "axisX" === this.type && this.labels[m] ? this.labels[m] : X(m, this.valueFormatString, this.chart._cultureInfo), a = new ka(this.ctx, {
                              x: 0,
                              y: 0,
                              maxWidth: g,
                              maxHeight: h,
      ...
      C.prototype.createLabelsAndCalculateHeight = function() {
          ...
          if ("bottom" ===
              ...
              for (b = 0; b < this._labels.length; b++) { f = this._labels[b].textBlock; var c = f.measureText(),
                      e = 0,
      ...
      C.prototype.renderStripLinesOfThicknessType = function(a) {
          if (this.stripLines && 0 < this.stripLines.length && a) {
              for (var f = this, b, c = 0, e = 0, g = !1, h = !1, l = [], m = [],
                      h = !1, c = 0; c < this.stripLines.length; c++) { var k = this.stripLines[c];
              ...
              if (this.scaleBreaks)
                  for (c = 0; c < this.scaleBreaks._appliedBreaks.length; c++)
                      if ((!y(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[c].startValue || !y(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[c].startValue || !y(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[c].startValue) &&
                          (!y(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[c].endValue || !y(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[c].endValue || !y(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[c].endValue)) { this.scaleBreaks._appliedBreaks.splice(c, 1); break }
              if ("axisX" === this.type) {
      ...
      C.getNiceExponent = function(a, f) { var b = Math.floor(Math.log(a) / Math.LN10),
              c = a / Math.pow(10, b),
          ...
          if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
              ...
              if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                  ...
                  for (n = 0; n < r; n++) this.ctx.bezierCurveTo(m + g * a, k - a, m + g * a, k - 2 * a, m, k - 3 * a), k -= 3 * a, g *= -1
                      ...
                      k = e + a;
                      m = c + a;
                      r = (l - k) / a / 2; for (n = 0; n < r; n++) this.ctx.lineTo(m, k), m += 2 * g * a, k += 2 * a, g *= -1;
                      this.ctx.lineTo(m, k);
                      m += h - c; for (n = 0; n < r + 1; n++) this.ctx.lineTo(m, k), m += 2 * g * a, k -= 2 * a, g *= -1;
                      this.ctx.lineTo(m + g * a, k + a) } } else if ("left" === this.scaleBreaks.parent._position || "right" ===
                  ...
                  k = e;
                  g = 0.5;
                  r = (h - m) / a / 3; for (n = 0; n < r; n++) this.ctx.bezierCurveTo(m + a, k + g * a, m + 2 * a, k + g * a, m + 3 * a, k), m += 3 * a, g *= -1;
                  this.ctx.bezierCurveTo(m + a, k + g * a, m + 2 * a, k + g * a, m + 3 * a, k);
                  k = l;
                  g *= -1;
                  this.ctx.lineTo(m, k); for (n = 0; n < r; n++) this.ctx.bezierCurveTo(m - a, k + g * a, m - 2 * a, k + g * a, m - 3 * a, k), m -= 3 * a, g *= -1 } else if ("zigzag" === this.type) {
                  g = 1;
                  k = e - a;
                  m = c + a;
                  r = (h - m) / a / 2;
          ...
          if (this.snapToDataPoint) {
              ...
              if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                  ...
                  if ("bottom" === this.parent._position || "top" === this.parent._position) {
                      ...
                      if (u) { if ("axisX" === this.parent.type)
                          ...
                          value: m.dataPoint.x
                      }) : y(this.options.label) ? Ba(m.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.x }) : y(this.options.label) ? X(m.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                  ...
                  if ("rangeColumn" === this.parent.dataSeries[q].type || "rangeArea" === this.parent.dataSeries[q].type || "error" === this.parent.dataSeries[q].type || "rangeSplineArea" === this.parent.dataSeries[q].type || "candlestick" === this.parent.dataSeries[q].type || "ohlc" === this.parent.dataSeries[q].type || "boxAndWhisker" === this.parent.dataSeries[q].type) {
                      ...
                      l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.y }) : y(this.options.label) ? X(m.dataPoint.y, this.valueFormatString,
              ...
              if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                  if ("left" === this.parent._position || "right" === this.parent._position) {
                      ...
                      }) : y(this.options.label) ? Ba(this.parent.convertPixelToValue(f), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(f) }) : y(this.options.label) ? X(this.parent.convertPixelToValue(f), this.valueFormatString, this.chart._cultureInfo) : this.label);
