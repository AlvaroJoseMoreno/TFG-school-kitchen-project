...
let transporter = nodemailer.createTransport({
  ...
  const sendEmailRecovery = async (email, name, code, uid) => {
    try {
        await transporter.sendMail({
            from: `"TFG-Project"" <tfgprojectua@gmail.com>`, // sender address
            ...
            Buenos días ${name},</h3></td>
            </tr>
            <tr style="border-collapse:collapse">
            <td align="left" style="padding:0;Margin:0;padding-bottom:10px;padding-top:15px">
                        <p> Has solicitado un cambio de contraseña ${name}, para generar unos credenciales
                        nuevos para tu cuenta pincha en el enlace de abajo y podrás generar una nueva contraseña.</p>
                        <a href="${dominioo}/login/recovery/${code}/?id=${uid}" target='_blank'>Nueva contraseña</a></p></td>
            </tr>
            </table></td>
            </tr>
            </table></td>
